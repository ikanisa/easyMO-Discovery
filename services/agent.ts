...
import type { Message, Location, ChatSession as ChatSessionType } from '../types';
...
export interface StreamingChunk {
  type: 'start' | 'token' | 'tool_result' | 'done' | 'error';
  content?: string;
  tool_call?: any; // Present in tool_result chunks
