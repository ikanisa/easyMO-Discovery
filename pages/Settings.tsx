              ...
              <div className="flex items-center justify-between mb-2">
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-slate-600 dark:text-slate-400">Agent remembers your preferences</div>
                    </div>
                 </div>
                 <button 
           ...
           <div className="bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl p-4 flex items-center justify-between shadow-sm">
              <div className="flex items-center gap-3">
                 ...
                 <div>
                    ...
                    <div className="text-xs text-slate-600 dark:text-slate-400">Adjust app appearance</div>
                 </div>
              </div>
              <button 
                onClick={toggleTheme}
