...
const Login: React.FC<LoginProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full items-center justify-center p-6 bg-slate-50 dark:bg-[#0f172a] relative overflow-hidden transition-colors duration-300">
